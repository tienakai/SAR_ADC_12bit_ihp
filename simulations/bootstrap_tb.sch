...
"}
C {devices/vsource.sym} -110 -170 0 0 {name=V9 value="pulse(0 1.2 0 0.1n 0.1n 50n 100n)"}
C {devices/vsource.sym} 40 -70 0 0 {name=V13 value="sin(0.3 0.3 100k 0 0 0)"}
C {devices/vsource.sym} -350 -120 0 0 {name=V1 value=1.2 savecurrent=true}
