...
.tran 10n 10u
"}
C {devices/vsource.sym} 500 -710 0 0 {name=V8 value="pwl(0 0 10n 0 10.1n 1.8)" savecurrent=false}
...
C {devices/vsource.sym} 700 -730 0 0 {name=V1 value=1.8 savecurrent=true}
...
C {devices/vsource.sym} 1310 -990 0 0 {name=V2 value="PULSE(0 1.8 0n 1n 1n 40n 100n)" savecurrent=false}
C {devices/gnd.sym} 1310 -940 0 0 {name=l3 lab=GND}
C {devices/vsource.sym} 1320 -810 0 0 {name=V3 value="PULSE(1.8 0 0n 1n 1n 40n 100n)" savecurrent=false}
