...
C {devices/vsource.sym} -920 30 0 0 {name=V1 value=1.8}
...
"}
C {vsource.sym} -850 30 0 0 {name=V5 value="DC 1.2"}
C {gnd.sym} -620 90 0 0 {name=l6 lab=GND}
C {vsource.sym} -730 30 0 0 {name=V6 value="PULSE(0 1.8 0 1n 1n 5n 100n)"}
C {gnd.sym} -880 90 0 0 {name=l7 lab=GND}
C {vsource.sym} -520 30 0 0 {name=V8 value="DC 1.205"}
