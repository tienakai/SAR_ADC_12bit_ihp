...
.tran 10n 10u
"}
C {devices/vsource.sym} 170 -940 0 0 {name=V8 value="pwl(0 0 10n 0 10.1n 1.8)" savecurrent=false}
...
C {devices/vsource.sym} 370 -960 0 0 {name=V1 value=1.8 savecurrent=true}
...
device=resistor
m=1}
C {devices/vsource.sym} 520 -960 0 0 {name=V2 value="PULSE(0 1.8 0n 1n 1n 40n 100n)" savecurrent=false}
C {devices/gnd.sym} 520 -910 0 0 {name=l3 lab=GND}
C {devices/vsource.sym} 620 -720 0 0 {name=V3 value="PULSE(1.8 0 0n 1n 1n 40n 100n)" savecurrent=false}
...
C {devices/vsource.sym} 880 -720 0 0 {name=V7 value="0 PULSE(0 1.8 0 0.1n 0.1n 50n 100n)" savecurrent=true}
